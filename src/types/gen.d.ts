...
export type ConfigNames = 'bluzzi/eslint' | 'bluzzi/javascript' | 'bluzzi/node' | 'bluzzi/stylistic' | 'bluzzi/typescript' | 'bluzzi/react' | 'bluzzi/nextjs' | 'bluzzi/perfectionist'
